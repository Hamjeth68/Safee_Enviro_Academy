                ...
                <ul>
                    <li class="drop-down"><a href="">Learn With Us</a>
                        <ul>
                            ...
                            <li><a href="{{ url('/personal-development') }}">Continuing Professional Development </a>
                            </li>
        ...
        <main id="main">
            ...
            <section id="featured-services" class="featured-services">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                        <div
                            class="col-md-4 col-lg-4 d-flex align-items-stretch justify-content-center text-center mb-5 mb-lg-0">
                            <div class="icon-box" data-aos="fade-up" data-aos-delay="100" style="width: 16rem">
                                <div class="icon"><img class="Card-img" src={{ asset('img/Path-3.png') }} alt="">
                                </div>
                        ...
                        <div
                            ...
                            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                                <div class="icon"><img class="Card-img" src={{ asset('img/Group-6.png') }} alt="">
                                </div>
                        ...
                        <div
                            ...
                            <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                                <div class="icon"><img class="Card-img" src={{ asset('img/business-and-trade.png') }}
                                        alt=""></div>
            ...
            <section id="featured-services" class="featured-services">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                        ...
                        <div
                            class="col-md-4 col-lg-2 d-flex align-items-stretch justify-content-center text-center mb-5 mb-lg-0 rankbox">
                            <div class="icon-box ranktext" data-aos="fade-up" data-aos-delay="100">
                                <p class="card-text"><strong>Ranked 2nd</strong> in the UK for teaching in the Young
                        ...
                        <div
                            ...
                            <div class="icon-box ranktext" data-aos="fade-up" data-aos-delay="200">
                                <p class="card-text">The only UK University in QS World University Rankings <strong>Top
                                        50 Under 50</strong> 2021</p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="icon-box ranktext" data-aos="fade-up" data-aos-delay="300">
                                <p class="card-text">A climb of <strong>8 places</strong> in The Times / Sunday Times
                                    Good University Guide 2021</p>
                            </div>
                        </div>
                        ...
                        <div
                            class="col-md-4 col-lg-2 d-flex align-items-stretch justify-content-center text-center mb-5 mb-lg-0 rankbox">
                            <div class="icon-box ranktext" data-aos="fade-up" data-aos-delay="300">
                                <p class="card-text"><strong>"Amongst the world's top universities"</strong> in 13
                                    subject areas in the QS World University Rankings by Subject 2021</p>
                            </div>
                        </div>
                        ...
                        <div
                            class="col-md-4 col-lg-2 d-flex align-items-stretch justify-content-center text-center mb-5 mb-lg-0 rankbox">
                            <div class="icon-box ranktext" data-aos="fade-up" data-aos-delay="300">
                                <p class="card-text"><strong>Ranked 1st</strong> in the UK for teaching in the Young
                                    University Rankings 2022</p>
                            </div>
                        </div>
                        {{-- <div class="col-lg-0 col-md-0"></div> --}}
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="row col-12 mb-4">
                            <a href="{{ url('/') }}" class="logo ml-2"><img src={{ asset('img/acedemy.png') }}
                                    alt=""></a>
                        </div>
                        <div class="col-lg-5 col-md-6 footer-contact">
                            <p>At SafeEnviro Academy we offer the highest quality of academic and professional
                                experience in the Waste, Resource & Environmental Industry whilst working closely with
                                some of the leading professional membership organizations in the sector.
                                By studying with us, you will be part of a community driven by a desire to create a
