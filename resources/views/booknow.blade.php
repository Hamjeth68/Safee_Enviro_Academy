...
{{-- 
            ...
            @foreach ((array) session('cart') as $id => $details)
                @php $total += $details['p_ammount'] * $details['p_quantity'] @endphp
            @endforeach
    ...
    <script>
        ...
        >
          ...
          <span><strong><p id="total-price-holder"><span class="mr-1" ">${currency}</span><span>${getConvertedFees(calculateTotalAmount())}</p></strong></span>
        </li>
        </ul>
        `;
        ...
        >
          ${course.title}
          <span><span class="mr-1">${currency}</span>${getConvertedFees(course.fees)}</span>
        </li>
        `;
        }
    ...
    <div class="modal fade" id="course-1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        style="z-index: 9999;">
    ...
    <div class="modal fade" id="course-2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        style="z-index: 9999;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        ...
                        • Understanding and applying the waste hierarchy<br></br>
                        Who can participate?<br>
                        This course is for anyone new to the waste and resources sector, those currently dealing with their
                        organization’s waste and resources, and anyone wishing to develop or change their career. It is
                        particularly relevant to those in the local authority and private sector and those who need to
                        understand International waste policy
    ...
    <div class="modal fade" id="course-3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        style="z-index: 9999;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="course-4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        style="z-index: 9999;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="course-5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        style="z-index: 9999;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <h4>What this cover</h4>
                    <p>
                        • Understand how and why landfill gas is produced, what effects it can have on the natural and built
                        environment and best practice in managing the gas<br>
    ...
    <div class="modal fade" id="course-6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        style="z-index: 9999;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="course-7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        style="z-index: 9999;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <p><strong>
                            The Fire Safety Course is designed to raise awareness of fire hazards in the workplace and how
                            to act
                            safely in the event of an emergency fire situation, including selecting and using the correct
                            fire
