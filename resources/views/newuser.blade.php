        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 item">
                <div class="card item-card card-block">
                    ...
                    <h5 class="card-title  mt-3 mb-3">Sign Up</h5>
                    <p class="card-text">Register and get daily news..</p>
                    <a href="{{ url('emailForm') }}" class="btn btn-outline-secondary custom-green-bg pl-5 pr-5">Sign Up</a>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 item">
                <div class="card item-card card-block">
                    <img src="https://static.pexels.com/photos/262550/pexels-photo-262550.jpeg" alt="Photo of sunset">
                    <h5 class="card-title  mt-3 mb-3">Welcom Guest</h5>
                    <p class="card-text">Explore the World...</p>
                    <a href="{{ url('guest-login') }}" class="btn btn-outline-secondary custom-green-bg pl-5 pr-5">Guest</a>
                </div>
            </div>
            <!-- <div class="col-md-3 col-sm-6 item">
                <div class="card item-card card-block">
