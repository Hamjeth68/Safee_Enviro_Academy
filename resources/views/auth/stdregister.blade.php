...
@section('content')
    ...
    {{-- action="{{ route("register.createStudent") }}" --}}
    <!-- ======= Hero Section ======= -->
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">                    
                            {{-- <form method="POST" action='{{ url("/register/student/$url") }}' aria-label="{{ __('Register') }}"> --}}
                          
                            <form method="POST" action="{{ route("register.createStudent") }}" aria-label="{{ __('Register') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="profession_occupation" type="text"
                                            ...
                                            name="profession_occupation" required autocomplete="Profession / Occupation">
